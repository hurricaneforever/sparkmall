package com.lkj.sparkmall.mock

import java.util.{Properties, Random}

import com.lkj.sparkmall.common.ConfigurationBean.CityInfo
import com.lkj.sparkmall.common.ConfigurationUtil
import com.lkj.sparkmall.common.ConfigurationUtil.{RanOpt, RandomOptions}
...
object Realtime {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val broker = ConfigurationUtil.getConfigValue("kafka.broker.list")
    val topic =  "ads_log"
    // 创建Kafka生产者
